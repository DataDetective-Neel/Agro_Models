# train_regional_models.py - LightGBM Version
import pandas as pd
import numpy as np
...
class RegionalCropTrainer:
    ...
    def train_region_model(self, region_name):
        ...
        print(f"\n🚀 Training LightGBM model for {region_name}...")
        ...
        print(f"✅ {region_name} LightGBM model trained!")
    ...
    def save_models(self):
        ...
        for region in self.models:
            ...
            file_path = f"ML models/{region.lower()}_model.pkl"
...
def main():
    print("🌾 REGIONAL CROP MODEL TRAINING - LightGBM")
    print("=" * 50)
