# train_seasonal_specialized.py - LightGBM Version
import pandas as pd
import numpy as np
...
class SeasonalModelTrainer:
    ...
    def train_seasonal_model(self, season_name):
        """Train specialized model for each season"""
        print(f"🚀 Training SEASONAL LightGBM model for {season_name}...")
        ...
        print(f"✅ {season_name} seasonal LightGBM model trained!")
...
def main():
    print("🌤 TRAINING SEASONAL MODELS (Model 3) - LightGBM")
    print("=" * 50)
