# train_improved_models.py - LightGBM Version
import pandas as pd
import numpy as np
...
class ImprovedCropTrainer:
    ...
    def train_region_model(self, region_name):
        ...
        print(f"\n🚀 Training IMPROVED LightGBM model for {region_name}...")
        ...
        # Train IMPROVED LightGBM model with enhanced parameters
        model = LGBMClassifier(
            n_estimators=300,           # More trees for enhanced features
        ...
        print(f"✅ {region_name} IMPROVED LightGBM model trained!")
    ...
    def save_models(self):
        ...
        print(f"\n💾 Saving IMPROVED LightGBM models...")
...
def main():
    print("IMPROVED REGIONAL CROP MODEL TRAINING - LightGBM")
    print("=" * 60)
