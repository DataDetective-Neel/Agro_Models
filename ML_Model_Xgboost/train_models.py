...
print("\nTRAINING SOIL MOISTURE MODEL (XGBoost Regressor)...")
moisture_model = XGBRegressor(
...
print("Soil Moisture XGBoost Model trained")

# Train Crop Classification Model
print("\nTRAINING CROP CLASSIFICATION MODEL (XGBoost Classifier)...")
...
print("Crop Classification XGBoost Model trained")
...
print("All XGBoost models and artifacts saved to 'ML models/' directory")
...
print("Your Flask app is now ready to use these high-quality XGBoost models!")
