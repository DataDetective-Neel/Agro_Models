# train_regional_models.py - XGBoost Version
import pandas as pd
import numpy as np
...
class RegionalCropTrainer:
    ...
    def train_region_model(self, region_name):
        ...
        print(f"\n🚀 Training XGBoost model for {region_name}...")
        ...
        print(f"✅ {region_name} XGBoost model trained!")
...
def main():
    print("🌾 REGIONAL CROP MODEL TRAINING - XGBoost")
    print("=" * 50)
