# train_seasonal_specialized.py - XGBoost Version
import pandas as pd
import numpy as np
...
class SeasonalModelTrainer:
    ...
    def train_seasonal_model(self, season_name):
        ...
        print(f"🚀 Training SEASONAL XGBoost model for {season_name}...")
        ...
        # Train XGBoost model (optimized for seasonal data)
        model = XGBClassifier(
            n_estimators=150,
            max_depth=6,
            learning_rate=0.1,
        ...
        print(f"✅ {season_name} seasonal XGBoost model trained!")
    ...
    def save_models(self):
        ...
        for season in self.seasonal_models:
            ...
            joblib.dump(model_data, f"ML models/{season.lower()}_model.pkl")
            print(f"✅ Saved {season} seasonal model")

def main():
    print("🌤 TRAINING SEASONAL MODELS (Model 3) - XGBoost")
    print("=" * 50)
