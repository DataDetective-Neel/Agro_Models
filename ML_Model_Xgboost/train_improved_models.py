# train_improved_models.py - XGBoost Version
import pandas as pd
import numpy as np
...
class ImprovedCropTrainer:
    ...
    def train_region_model(self, region_name):
        ...
        print(f"\n🚀 Training IMPROVED XGBoost model for {region_name}...")
        ...
        # Train IMPROVED XGBoost model with enhanced parameters
        model = XGBClassifier(
        ...
        print(f"✅ {region_name} IMPROVED XGBoost model trained!")
    ...
    def save_models(self):
        ...
        print(f"\n💾 Saving IMPROVED XGBoost models...")
...
def main():
    print("IMPROVED REGIONAL CROP MODEL TRAINING - XGBoost")
    print("=" * 60)
