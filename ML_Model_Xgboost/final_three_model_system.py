# final_three_model_system.py - XGBoost Version
import joblib
import pandas as pd
import numpy as np
import os
...
class FinalThreeModelSystem:
    def __init__(self):
        print("🚀 INITIALIZING 3-MODEL CROP SYSTEM (XGBoost)")
        print("=" * 50)
        ...
        try:
            ...
            try:
                self.model1_features = joblib.load('ML models/crop_features.pkl')
            ...
            print("✅ MODEL 1: High-Accuracy XGBoost - LOADED")
        ...
        for region in regions:
            try:
                ...
                print(f"✅ MODEL 2: {region.title()} Regional XGBoost - LOADED")
            except:
                try:
        ...
        for season in seasons:
            try:
                ...
                print(f"✅ MODEL 3: {season.title()} Seasonal XGBoost - LOADED")
            except Exception as e:
    ...
    def predict_model1(self, features):
        ...
        try:
            ...
            return {
                'crop': crop_name,
                'confidence': 'High (XGBoost trained)',
                'model_type': 'High-Accuracy General XGBoost Model',
    ...
    def predict_model2(self, features):
        ...
        try:
            ...
            if 'improved' in [f for f in os.listdir('ML models') if region in f and 'improved' in f][0]:
            ...
            return {
                ...
                'model_type': f'{region.title()} Regional XGBoost Model',
                'features_used': len(feature_array[0])
            }
        except Exception as e:
    ...
    def predict_model3(self, features):
        ...
        try:
            ...
            return {
                'crop': crop_name,
                'confidence': f"{confidence:.1%}",
                'model_type': f'{season.title()} Seasonal XGBoost Model',
                'features_used': len(feature_array[0])
            }
        except Exception as e:
    ...
    def predict_all_models(self, features):
        ...
        print(f"\n🎯 GETTING PREDICTIONS FROM 3 XGBoost MODELS")
        print("=" * 40)
